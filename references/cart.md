...
- [ ] **Itemized price breakdown** — Clear summary listing subtotal, applied discounts, an estimated shipping fee, taxes, and final grand total, shown here in the cart rather than held back for a later checkout step — costs that surprise the user late in checkout are a common, avoidable cause of abandonment.
